...
const openDrawer = () => navigatorRef.current?.dispatch(DrawerActions.openDrawer())

const closeDrawer = () => navigatorRef.current?.dispatch(DrawerActions.closeDrawer())

const toggleDrawer = () => navigatorRef.current?.dispatch(DrawerActions.toggleDrawer())
